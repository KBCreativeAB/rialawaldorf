          ...
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-6">
              {siteContent.contact.methods.map((method) => (
                <div
                  key={method.label}
                  className="flex flex-col items-center lg:flex-row lg:items-start gap-4 p-4 rounded-2xl bg-card hover:bg-secondary/30 transition-colors text-center lg:text-left"
                >
