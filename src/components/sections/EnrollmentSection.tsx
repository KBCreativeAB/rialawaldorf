  ...
  return (
    <section id="inskolning" className="section-padding bg-card">
      <div className="container mx-auto">
        ...
        {/* Weekly Schedule */}
        <div className="bg-background rounded-3xl p-6 md:p-8 shadow-soft max-w-4xl mx-auto">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                <th className="text-center py-4 px-6 font-semibold text-primary">Dag</th>
                <th className="text-center py-4 px-6 font-semibold text-primary">Aktiviteter</th>
              </tr>
            </thead>
            <tbody>
              {siteContent.enrollment.schedule.days.map((day, index) => (
                ...
                >
                  <td className="py-4 px-6 font-medium text-primary text-center">{day.day}</td>
                  <td className="py-4 px-6 text-muted-foreground text-center">{day.activities}</td>
                </tr>
              ))}
            </tbody>
          </table>
