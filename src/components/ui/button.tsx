...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl shadow-soft hover:shadow-medium",
        ...
        cta: "bg-cta text-cta-foreground hover:bg-cta/90 rounded-2xl shadow-medium hover:shadow-lg hover:scale-105 font-semibold",
        hero: "bg-cta text-cta-foreground hover:bg-cta/90 rounded-2xl shadow-medium hover:shadow-lg hover:scale-105 font-semibold text-base",
        heroOutline: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground rounded-2xl font-semibold text-base",
        nav: "text-primary hover:text-cta font-medium bg-transparent",
      },
      size: {
