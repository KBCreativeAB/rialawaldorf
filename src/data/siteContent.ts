import { Heart, Sun, Leaf, Home, Users, Clock, Phone, Mail, MapPin, Utensils, BookOpen, Baby, Shield } from 'lucide-react';
...
export const siteContent = {
  ...
  hero: {
    ...
    highlights: [
      "Utbildad personal i Barn HLR",
      "Hemlik och trygg miljö",
      "Waldorfpedagogik sedan 1994"
    ],
  ...
  about: {
    ...
    intro: "Riala Waldorfförskola är en liten, hemlik förskola belägen i natursköna Riala. Sedan 1994 har vi välkomnat barn och familjer till vår varma och trygga miljö.",
    features: [
      {
        icon: "Shield",
  ...
  pedagogy: {
    title: "Vår pedagogik",
    intro: "Waldorfpedagogiken ser till hela barnet – huvud, hjärta och händer. Vi tror på lekens kraft och rytmens betydelse för barnets utveckling.",
    sections: [
      {
        icon: "Sun",
        title: "Rytm och rutiner",
        description: "Dagen följer en trygg rytm med återkommande aktiviteter som ger barnen stabilitet och förutsägbarhet. Veckan har sin egen rytm med olika teman för varje dag."
      },
      {
        icon: "Heart",
        title: "Fri lek",
        description: "Den fria leken är central i vår verksamhet. Genom leken utvecklar barnen fantasi, sociala färdigheter och problemlösningsförmåga på ett naturligt sätt."
      },
      {
        icon: "Leaf",
        title: "Naturen som klassrum",
        description: "Vi tillbringar mycket tid utomhus oavsett väder. Naturen erbjuder oändliga möjligheter till utforskande och lärande."
      },
      {
        icon: "Users",
        title: "Skapande verksamhet",
        description: "Målning, modellering, sång och sagostunder är naturliga delar av vår dag. Kreativitet och konstnärligt uttryck uppmuntras."
      }
    ]
  },
  ...
  enrollment: {
    title: "Inskolning",
    intro: "Inskolningen är en viktig period som lägger grunden för barnets trygghet hos oss. Vi tar god tid på oss för att varje barn ska känna sig hemma.",
    duration: "2 veckor",
    steps: [
      {
        step: 1,
      ...
      },
      {
        step: 2,
        title: "Vecka 1",
        description: "Korta besök tillsammans med förälder. Barnet lär känna miljön, pedagogerna och de andra barnen i trygg närvaro av sin förälder."
      },
      {
        step: 3,
        title: "Vecka 2",
    ...
    sections: [
      {
        id: "hitta-hit",
        title: "Hitta hit",
        content: "Riala Waldorfförskola ligger i hjärtat av Riala, en liten ort i Norrtälje kommun. Vi har goda parkeringsmöjligheter och ligger nära naturen."
      },
      {
        id: "oppettider",
        title: "Öppettider",
      ...
      },
      {
        id: "klagomal",
        title: "Klagomål",
        content: "Vi välkomnar återkoppling och strävar alltid efter att förbättra vår verksamhet. Kontakta rektor om du har synpunkter eller klagomål."
      }
    ]
  },
